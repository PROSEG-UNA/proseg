...
import com.proseg.common.kafka.events.UserLoginEvent;
import com.proseg.common.kafka.events.UserRegisteredEvent;
import com.proseg.common.kafka.topics.KafkaTopics;
import com.proseg.msvc_auth.dto.*;
import com.proseg.msvc_auth.exception.PasswordExpiredException;
import com.proseg.msvc_auth.service.*;
...
public class AuthController {
    ...
    @GetMapping("/me")
        ...
        if (authToken == null || authToken.isBlank()) {
            throw com.proseg.msvc_auth.exception.TokenException.notFound();
        }
    ...
    public ResponseEntity<ApiResponse<KeycloakTokenDto>> refresh(
        ...
        if (refreshTokenValue == null || refreshTokenValue.isBlank()) {
            throw com.proseg.msvc_auth.exception.TokenException.refreshTokenNotFound();
        }
