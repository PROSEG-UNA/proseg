package com.proseg.msvc_transport.config;
...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    private String resolveMessage(AuthenticationException ex) {
        ...
        if (cause.contains("invalid") || cause.contains("malformed")) return "Token invalido";
        if (cause.contains("signature")) return "Firma invalida";
