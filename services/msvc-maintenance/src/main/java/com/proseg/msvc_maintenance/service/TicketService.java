...
public interface TicketService {
    ...
    Page<com.proseg.msvc_maintenance.dto.response.TicketHistoryChangeResponseDto> findHistoryByTicket(UUID id, Pageable pageable, Authentication authentication);
}