...
import com.proseg.common.api.exception.AssetException;
import com.proseg.common.api.exception.BuildingException;
import com.proseg.common.api.exception.FloorException;
import com.proseg.common.api.exception.LocationException;
import com.proseg.common.api.exception.CampusException;
...
import com.proseg.msvc_maintenance.dto.request.TicketCreateRequestDto;
...
import com.proseg.msvc_maintenance.dto.response.TicketAssetResponseDto;
import com.proseg.msvc_maintenance.dto.response.TicketCommentResponseDto;
import com.proseg.msvc_maintenance.dto.response.TicketDashboardMetricItemDto;
...
public class TicketServiceImpl implements TicketService {
    ...
    private final com.proseg.msvc_maintenance.repository.TicketHistoryChangeRepository ticketHistoryChangeRepository;
    ...
    public TicketResponseDto updatePriority(UUID id, TicketPriorityUpdateRequestDto request,
        ...
        com.proseg.msvc_maintenance.entity.enums.TicketPriority oldPriority = ticket.getPriority();
        ticket.setPriority(request.getPriority());
        ticket.setUpdatedBy(extractUserId(authentication));
        Ticket saved = ticketRepository.save(ticket);

        if (oldPriority == null || !oldPriority.equals(saved.getPriority())) {
            saveHistory(saved, com.proseg.msvc_maintenance.entity.enums.TicketHistoryChangeType.PRIORITY_CHANGED,
    ...
    public TicketResponseDto updateAssignedTo(UUID id, TicketAssignedToUpdateRequestDto request,
        ...
        if (!java.util.Objects.equals(oldAssignedTo, saved.getAssignedTo())) {
            ...
            saveHistory(saved, com.proseg.msvc_maintenance.entity.enums.TicketHistoryChangeType.EDITED,
    ...
    public void deleteComment(UUID ticketId, UUID commentId, Authentication authentication) {
        ...
        saveHistory(ticket, com.proseg.msvc_maintenance.entity.enums.TicketHistoryChangeType.COMMENT_REMOVED,
    ...
    public TicketResponseDto updateStatus(UUID id, TicketStatusUpdateRequestDto request,
        ...
        if (!java.util.Objects.equals(oldStatus, saved.getStatus())) {
            saveHistory(saved, com.proseg.msvc_maintenance.entity.enums.TicketHistoryChangeType.STATUS_CHANGED,
                    "status",
    ...
    @Override
    @Transactional(readOnly = true)
    public List<com.proseg.msvc_maintenance.dto.response.TicketPhotoResponseDto> getPhotos(UUID id,
                                                                                         Authentication authentication) {
        Ticket ticket = ticketRepository.findById(id)
                .orElseThrow(TicketException::notFound);
        ...
        return ticket.getTicketPhotos().stream()
                .map(photo -> {
                    ...
                    return com.proseg.msvc_maintenance.dto.response.TicketPhotoResponseDto.builder()
                            .id(photo.getId())
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<com.proseg.msvc_maintenance.dto.response.TicketHistoryChangeResponseDto> findHistoryByTicket(
    ...
    private com.proseg.msvc_maintenance.dto.response.TicketHistoryChangeResponseDto toHistoryResponse(
            com.proseg.msvc_maintenance.entity.TicketHistoryChange history) {
        return com.proseg.msvc_maintenance.dto.response.TicketHistoryChangeResponseDto.builder()
                .id(history.getId())
    ...
    private void saveHistory(Ticket ticket, com.proseg.msvc_maintenance.entity.enums.TicketHistoryChangeType type,
                             String fieldName, String oldValue, String newValue, String authorId, String metadata) {
        com.proseg.msvc_maintenance.entity.TicketHistoryChange history = com.proseg.msvc_maintenance.entity.TicketHistoryChange
                .builder()
                .ticket(ticket)
                .type(type)
                .fieldName(fieldName)
    ...
    private List<String> resolveLocationEmails(UUID siteId, UUID buildingId) {
        ...
        try {
            if (siteId != null) {
                ApiResponse<List<com.proseg.msvc_maintenance.dto.response.InventoryBuildingEmailResponseDto>> response =
    ...
    private List<String> extractLocationEmails(ApiResponse<List<com.proseg.msvc_maintenance.dto.response.InventoryBuildingEmailResponseDto>> response) {
        List<com.proseg.msvc_maintenance.dto.response.InventoryBuildingEmailResponseDto> data =
        ...
        return data.stream()
                .map(com.proseg.msvc_maintenance.dto.response.InventoryBuildingEmailResponseDto::getEmail)
                .filter(email -> email != null && !email.isBlank())
                .toList();
    }
