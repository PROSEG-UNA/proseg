...
public class ArchiveService {
    ...
    public ArchiveUploadInitResponseDto initiateMultipartUpload(String filename, String objectName, String folder, String contentType) {
    ...
    public ArchiveUploadPartResponseDto uploadPart(String uploadId, String objectName, int partNumber, MultipartFile chunk) {
        try {
            ...
            throw new RuntimeException("No fue posible subir la parte del archivo", exception);
        }
    }

    public ArchiveUploadResponseDto completeMultipartUpload(String uploadId, String objectName, long totalSize) {
        try {
            ...
            if (sources.isEmpty()) {
                throw new RuntimeException("No existen partes para completar la carga");
            }
            ...
            throw new RuntimeException("No fue posible completar la carga por partes", exception);
        }
    }
    ...
    public ArchiveDownload download(String objectName) {
        try {
            ...
            throw new RuntimeException("No fue posible descargar el archivo", exception);
        }
    }
    ...
    private String resolveObjectName(String filename, String objectName, String folder) {
        ...
        String resolvedFolder = folder == null || folder.isBlank() ? "" : folder.replace("\\", "/").replaceAll("/+$", "") + "/";
