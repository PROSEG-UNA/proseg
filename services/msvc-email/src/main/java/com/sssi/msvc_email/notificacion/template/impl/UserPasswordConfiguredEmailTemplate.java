...
@Builder
public class UserPasswordConfiguredEmailTemplate
        implements EmailTemplateDefinition {
    ...
    public String getTemplateName() {
        return "user-password-configured-email";
    }
    ...
    public Context buildContext() {
        ...
        ctx.setVariable("timestamp",
                DateUtils.formatReadable(timestamp));
    ...
    private void validate() {
        ...
        String template = "UserPasswordConfiguredEmailTemplate";
