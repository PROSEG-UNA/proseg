...
@Builder
public class PasswordExpiredResetEmailTemplate implements EmailTemplateDefinition {
    ...
    public String getTemplateName() {
        return "password-expired-reset-email";
    }
    ...
    private void validate() {
        ...
        String template = "PasswordExpiredResetEmailTemplate";
