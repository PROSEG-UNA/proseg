...
- `apps/` → Aplicaciones del sistema (frontend, gateway)
- `services/` → Microservicios de negocio e infraestructura
...
### Dirección
- **William Hernandez Cordoba** – Dirección del proyecto

### Desarrolladores
- **Christofer Chaves Pauth**
