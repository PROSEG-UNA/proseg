...
Set-RoleDomain "LEER_UBICACIONES"      "Inventario"
Set-RoleDomain "GESTIONAR_UBICACIONES" "Inventario"
Set-RoleDomain "ELIMINAR_UBICACIONES"  "Inventario"
...
Set-RoleDomain "LEER_REGISTROS_MANTENIMIENTO"        "Mantenimiento"
Set-RoleDomain "GESTIONAR_REGISTROS_MANTENIMIENTO"   "Mantenimiento"
Set-RoleDomain "LEER_HISTORIAL_REGISTROS_MANTENIMIENTO" "Mantenimiento"
